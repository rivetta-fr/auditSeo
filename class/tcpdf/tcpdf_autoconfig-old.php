...
if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'Officinalab');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Officinalab doc');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by Officinalab - http://officinalab.fr");
}
